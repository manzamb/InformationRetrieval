...
//Referencias de las librerias a usar de Lucene
...
namespace Buscar_con_Lucene.Search
{
    class LuceneSearch
    {
        //Aquí se colocan todos los métodos de Lucene
        private static string _luceneDir = Path.Combine(System.IO.Directory.GetCurrentDirectory(), "lucene_index");
        // Para aplicación Web: Path.Combine(HttpContext.Current.Request.PhysicalApplicationPath, "lucene_index");
        private static FSDirectory _directoryTemp;
        //Creación del directorio en el cual Lucene colocarac el indice a crear
        ...
        //Lucene creará un índice de búsqueda basado en algunos datos reales, en nuestro caso sería una Lista
        //<SampleData> con varios registros, o un registro de SampleData. El primer método que necesitamos es
        //un método privado que crea una sola entrada de índice de búsqueda basada en nuestros datos, y será
        //reutilizada por métodos públicos que agregamos más adelante
        ...
        //Metodo para borrar toto el índice
        ...
        //Método para optimizar el índice
        ...
        //Método para mapear la salida del índice
        ...
        //Otros métodos de mapeo de la salidad del índice
        ...
        //Método público de búsqueda que sera llamado desde la interfaz
        ...
        //Método de búsqueda predeterminado
        ...
        //Método para imprimir todo el índice
